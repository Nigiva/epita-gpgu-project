...
# Convert MP4 to JPG
## reference.jpg input-0001.jpg input-0002.jpg input-0003.jpg
...
reference_path = os.path.join(export_path, "reference.jpg")
...
while success:
    image_path = os.path.join(export_path, f"input-{count:04d}.jpg")
